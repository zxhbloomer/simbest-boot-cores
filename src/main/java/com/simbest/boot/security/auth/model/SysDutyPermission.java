...
@Builder
@Entity
public class SysDutyPermission {

    @Id
    @Column(name = "id")
    @SequenceGenerator(name = "sys_duty_permission_seq", sequenceName = "sys_duty_permission_seq", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.AUTO, generator = "sys_duty_permission_seq")
    private Integer id;
